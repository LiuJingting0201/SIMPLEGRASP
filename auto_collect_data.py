...
class AutoAffordanceCollector:
    ...
    def collect_single_attempt_as_scene(self, scene_idx, robot_id, object_ids):
    ...
    def collect_dataset(self, num_scenes, num_objects_range=(2, 4), max_attempts_per_scene=25):
        ...
        for scene_id in range(num_scenes):
            ...
            success = self.collect_single_attempt_as_scene(scene_id, robot_id, object_ids)
            
            # 读取场景统计信息
            import json
            meta_file = os.path.join(self.data_dir, f"scene_{scene_id:04d}_meta.json")
